...
| 018 | Availability Toggle, Base/Home in Order & Standby, Commanders Feature | Replace "דלג" with a Base/Home toggle in Step3_Order, add the same toggle to StandbyScreen, add a commanders concept to groups, and divide StandbyScreen into a commander selector and a warriors section. |