      ...
      <div className="mb-8 flex flex-col gap-3">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 rounded-2xl bg-yellow-800 py-4 text-base font-semibold text-white shadow-lg active:bg-amber-600"
          >
            ⚡ רשימה קצרה
          </button>
          <button
            onClick={() => navigate('/standby')}
            className="flex-1 rounded-2xl bg-orange-500 py-4 text-base font-semibold text-white shadow-lg active:bg-orange-600"
          >
            🛡️ כיתת כוננות
          </button>
        </div>
